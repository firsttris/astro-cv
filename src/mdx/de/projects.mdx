...
<br/>
<b>Implementierung des Automationscheck für Werbesendungen im Geschäftskundenportal der DHL</b>
...
- Erstellung von Buildskripten zum erstellen von Single-Page-App (SPA) und Microfrontend (MIFO).
...
<b>Integration des Print-Mailing-Planner in das Geschäftskundenportal der DHL</b>
### Position: Frontend-Entwickler
- Unterstützung bei der Integration des Printmailing-Planner (eine Angular-17 Anwendung) in das Geschäftskundenportal der DHL.
- Optimierung von Buildskripten hinsichtlich Single-Spa.
- Implementierung eines SSO-Logins mit Keycloak.js für den Printmailing-Planner im Geschäftskundenportal der DHL.

...
- Integration des Automationschecks in das Geschäftskundenportal unter Verwendung der Single-Spa (Microfrontend-Architektur).
- Erstellung und Verwaltung von Build-Jobs für Single-Page-Apps (SPA) und Microfrontends (MIFO).
- Entwicklung einer umfassenden Test-Suite mit Playwright für den Automationscheck.
- Wissensvermittlung und Schulung von Teammitgliedern in React und TypeScript.
- Implementierung eines SSO-Logins mit Keycloak für den Printmailing Planner (eine Angular-Anwendung) im Geschäftskundenportal.
- Unterstützung bei der Integration des Printmailing Planners in das Geschäftskundenportal.
...
<AvoidPageBreakInside>
## Entwicklung und Testing von Webanwendungen mit Fokus auf Orchestrierung in AWS und CI/CD Automatisierung
RWE AG
...
- Entwicklung und Testing von state-less Funktionen in AWS Lambda und deren Integration in AWS Step Functions zur Automatisierung von Workflows.
